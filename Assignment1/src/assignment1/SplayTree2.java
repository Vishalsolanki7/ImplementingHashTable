...
*/
public class SplayTree2<AnyType extends Comparable<? super AnyType>>
{
 /**
  * Construct the tree.
  */
 ...
 {
     SplayTree2<Integer> t = new SplayTree2<Integer>( );
     ...
     System.out.println( "Average time of insertion is: " + ((endTime-startTime )/NUMS));
     ...
     System.out.println( "Average time of searching is: " + ((endTime-startTime )/NUMS));
     startTime = System.nanoTime( );
     ...
     for(int i=1;i<=100000;i++){
         ...
         t.remove( randomNumber );
     }
     endTime = System.nanoTime( );
     System.out.println( "Average time of deleting is: " + ((endTime-startTime )/NUMS));
